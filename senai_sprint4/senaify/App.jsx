...
export default function App() {
  ...
  const _getApiSpotifyToken = async () => {
    ...
    const _clientId = "5fb99049f06d45d3a001dd42f882655a";
    const _clientSecret = "2ed3c3cf20704fd29e7e001acbf438ff";
    ...
    await axios
      .post("https://accounts.spotify.com/api/token", formUrl, {
        headers: {
      ...
      <NavigationContainer>
        <BottomTab.Navigator
          ...
          screenOptions={({ route }) => ({
            ...
            tabBarIcon: ({ focused }) => {
              return (
                <ContentIcon tabBarActiveBackgroundColor={"transparent"}>
                  {route.name == "Home" ? (
                    <FontAwesome6
                      name="house"
                      size={20}
                      color={focused ? "#fbfbfb" : "#ACABB7"}
                    />
                  ) : route.name == "Search" ? (
                    <MaterialIcons
                      name="search"
